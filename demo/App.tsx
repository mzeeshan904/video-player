...
// Professional video player demo with complete ad system integration

const App: React.FC = () => {
  const currentConfig = testConfigurations['🚀 Instant Demo (AUTOPLAY)'];
  const configName = '🚀 Instant Demo (AUTOPLAY)';
